...
//        1
        String formattedString = String.format("Order with Order# : %d" +
                " and Quantity: %d is Ready",40021,3000);
...
//        8
        String message = String.format("Total %,d orders processes today",60000000);
